    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
                <a class="navbar-brand" href="#" style="color:blue">FILE SHARING</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('lang.switch', ['locale' => 'ar']) }}">Arabic</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled">{{ __('messages.Disabled') }}</a>
                        </li>
                    </ul>
